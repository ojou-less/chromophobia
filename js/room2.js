...
room1.preload = function()
{
    ...
    this.load.image("tiles1", "assets/images/swamp_.png");
    this.load.image("tiles1_resources", "assets/images/swamp_resources.png");
    this.load.tilemapTiledJSON("map1", "assets/json/chromophobia_room2.json");
...
room1.create = function()
{
    ...
    const tileset = map.addTilesetImage("swamp_", "tiles1");
    const treetiles = map.addTilesetImage("swamp_ [resources]", "tiles1_resources");
    ...
    */
    ...
    this.physics.add.collider(player.getEntity(), treelayer, sceneCompleted, null, this);
